...
async function runTests(port, stop) {
    ...
    for (const contract of Object.values(contractkit_1.CeloContract)) {
        // Skip contracts that are deployed individually.
        if (contract === contractkit_1.CeloContract.ERC20 ||
            contract === contractkit_1.CeloContract.MetaTransactionWallet ||
            contract === contractkit_1.CeloContract.MetaTransactionWalletDeployer ||
            contract === contractkit_1.CeloContract.MultiSig) {
            continue;
        }
