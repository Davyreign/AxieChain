...
export interface SampleRedstoneConsumerNumericMockInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getUniqueSignersThreshold" | "getValueForDataFeedId" | "getValueManyParams" | "latestSavedValue" | "returnMsgValue" | "revertWithTestMessage" | "revertWithoutMessage" | "saveOracleValueInContractStorage" | "validateTimestamp"): FunctionFragment;
...
export interface SampleRedstoneConsumerNumericMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SampleRedstoneConsumerNumericMockInterface;
...
//# sourceMappingURL=SampleRedstoneConsumerNumericMock.d.ts.map