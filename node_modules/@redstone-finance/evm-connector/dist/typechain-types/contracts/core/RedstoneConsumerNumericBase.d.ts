...
export interface RedstoneConsumerNumericBase extends BaseContract {
    ...
    functions: {
        ...
        getAuthorisedSignerIndex(receviedSigner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[number]>;
    ...
    estimateGas: {
        aggregateValues(values: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<BigNumber>;
        getAuthorisedSignerIndex(receviedSigner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getAuthorisedSignerIndex(receviedSigner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=RedstoneConsumerNumericBase.d.ts.map